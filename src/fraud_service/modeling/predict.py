...
def predict_one(bundle: ModelBundle, feats: Dict[str, float]) -> Dict[str, Any]:
    ...
    return {
        ...
        "drift_updated": bool(drift_out.get("updated", False)),
        "drift_ready": bool(drift_out.get("ready", False)),
        "drift_samples_collected": drift_out.get("samples_collected"),
        "drift_samples_until_ready": drift_out.get("samples_until_ready"),
